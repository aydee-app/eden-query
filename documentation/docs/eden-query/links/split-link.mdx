...
import { httpBatchLink, httpLink, splitLink } from '@aydee-app/eden-react-query'
...
import type { EdenLink, Operation } from '@aydee-app/eden-react-query'
...
[GitHub](https://github.com/aydee-app/eden-query/blob/main/packages/eden/src/links/split-link.ts).
