...
import { LOCAL_INDEX, type NormalizedSearchResultItem, type Provider } from './providers'
...
import { backTrackHeaders, byteToCharIndex, getStrByteLength, normalizeTextCase } from './utils'

export function normalizeHref(a: string) {
  return a
...
export class PageSearcher {
  ...
  constructor(options: SearchOptions & { indexName?: string }, provider?: Provider) {
