...
import type { Observer } from '../internal/observable'
import type { EdenClientOutgoingMessage, EdenResponseMessage } from '../internal/operation'
import { withResolvers } from './utils'

export type TCallbacks = Observer<
  EdenResponseMessage<unknown, EdenClientError<AnyElysia>>,
  EdenClientError<AnyElysia>
>
...
export class RequestManager {
   ...
   */
  public register(message: EdenClientOutgoingMessage, callbacks: TCallbacks) {
