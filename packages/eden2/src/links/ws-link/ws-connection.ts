import { behaviorSubject } from '../internal/behavior-subject'
import type { UrlOptionsWithConnectionParams } from './options'
 ...
 */
function setupPingInterval(ws: WebSocket, { intervalMs, pongTimeoutMs }: PingPongOptions) {
