import type { EdenConnectionParams, EdenConnectionParamsMessage } from '../internal/operation'
import { type CallbackOrValue, resultOf, type UrlOptionsWithConnectionParams } from './options'
...
export async function buildConnectionMessage(
  connectionParams: CallbackOrValue<EdenConnectionParams>,
) {
  const message: EdenConnectionParamsMessage = {
