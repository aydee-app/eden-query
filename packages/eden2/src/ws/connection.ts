import type { EdenBaseEnvelope } from '../links/internal/operation'
import { behaviorSubject } from '../observable/behavior-subject'
import { resolveCallbackOrValue } from '../utils/resolve-callback-or-value'
...
export interface EdenConnectionParamsMessage extends EdenBaseEnvelope {
